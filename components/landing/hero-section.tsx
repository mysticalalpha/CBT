...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-between items-start overflow-hidden bg-transparent">
      {/* Main content container */}
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 pt-28 pb-6 md:pt-36 lg:pt-40 flex-grow flex flex-col justify-center">
      ...
      <div
        className={`w-full px-6 lg:px-12 pb-12 transition-all duration-700 delay-500 ${
